...
export default function AddRadiologyForm({ onCancel, onSubmit }: { onCancel: () => void, onSubmit: (data: { name: string, cost: string, code: string }) => void }) {
  ...
  return (
    <div className="fixed inset-0 flex items-center justify-center bg-black bg-opacity-30 z-50">
      <form onSubmit={handleSubmit} className="bg-white p-6 rounded-lg shadow-lg min-w-[300px]">
        <h3 className="text-lg font-semibold mb-4">Add Radiology Test</h3>
        <input
